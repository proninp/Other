namespace BicImport
{
    public class Params
    {
        ...
        public const string RSTRLIST = "RstrList";
        public const string CBR_DOWNLOAD_LINK = @"http://www.cbr.ru/s/newbik";
        public const string ZIP_FILE_NAME = @"BicZip.zip";
        public const string ZIP_DOWNLOAD_DIR = @"\\SampleDirectory\BicImport\";
        public const string XML_DOWNLOAD_DIR = @"\\SampleDirectory\BicImport\Xml\";
